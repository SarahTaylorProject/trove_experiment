...
def return_town_list_from_existing_ptv_stop_files(input_path_name, gtfs_file_name='gtfs.zip', default_stop_file_name='stops.txt', stop_field_num=1)
   result = false
   begin
