...
def return_random_poetry(author_list=["Browning", "Byron", "Dickinson", "Po", "Shakespeare", "Shelley", "Tennyson", "Wilde"], min_length=8, max_tries=10, full_metadata=True):
  """ 
  ...
  try:  
    ...
    if (isinstance(poem_choice, dict)):
      ...
      if ("lines" in poem_choice.keys()):  
        ...
        print("RANDOM LINE: '", random_poetry, "'")
...
def return_random_bible(book_list=None, max_chapters=80, max_tries=80):
  """
